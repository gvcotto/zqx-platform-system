...
const copy = {
  es: {
    ...
    authSubtitle: "Ingresa con una cuenta autorizada por tu organización.",
    accessPending: "Tu cuenta fue registrada, pero aún no tiene acceso activo. Un administrador de ZQX debe asignarte empresa, rol y estado activo.",
    accessDisabled: "Tu acceso está deshabilitado. Solicita activación al administrador de ZQX.",
    accessNotFound: "Tu cuenta no está autorizada en esta plataforma. Solicita alta al administrador de ZQX.",
    ...
    capabilities: [
      {
        ...
        detail: "Control de usuarios, módulos y espacios de trabajo por cliente.",
        visual: "multi",
        image: "/logos/zqx.svg",
        imageAlt: "ZQX logo",
      },
